			...
			<h3 id='title'>Ziti Quiz</h3>
				<center>
					...
					<table id='tablestyle'>
						...
						<td id='d2'>
							Designed and developed by Department of Defense (DoD) in 1960s and is based on standard protocols. It stands for Transmission Control Protocol/Internet Protocol. 
							</td >
						</tr>
					</table>
				</center>
